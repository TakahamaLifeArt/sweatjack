<?php
	...
	$category_selector .= '<option value="0" data-cat="sweat">パーカー</option>';
	$category_selector .= '<option value="1" data-cat="sweat">トレーナー</option>';
	$category_selector .= '<option value="2" data-cat="sweat">パンツ</option>';
	$category_selector .= '<option value="3" data-cat="t-shirts">Tシャツ</option>';
	$category_selector .= '<option value="4" data-cat="outer">ブルゾン</option>';
	...
	<div id="container">
		...
		<div class="contents" style="z-index:5;">
			...
			<div class="heading1_wrapper">
				<h2  class="titlelogo">お申し込みフォーム</h2>
				<p class="comment">
					FAXでのお申し込みをご希望の方は、<br /><a href="/guide/sheet1.php">FAX用デザイン用紙</a>をプリントして送信できます。
				</p>
			...
			<div id="gall">
				<div id="step1" class="is-appear">
					...
					<div class="crumbs_wrap">
						<div class="crumbs pass step_first">
							<p>Step1</p>
							<div id="step_word">プリントする<br>アイテムを選択</div>
						</div>
						<div class="crumbs">
							<p>Step2</p>
							<div id="step_word">カラー・サイズ<br>枚数入力</div>
						</div>
						<div class="crumbs">
							<p>Step3</p>
							<div id="step_word">プリント位置<br>を指定</div>
						</div>
						<div class="crumbs">
							<p>Step4</p>
							<div id="step_word"><img alt="カート" src="./img/cart.png" />カート<br>に入れる</div>
						</div>
						<div class="crumbs">
							<p>Step5</p>
							<div id="step_word">お客様情報<br>の入力</div>
						</div>
						<div class="crumbs step_fin">
							<p>Step6</p>
							<div class="fin" id="step_word">内容を確認して<br>お申し込み</div>
						</div>
					</div>
				...
				<div id="step2">
					...
					<div class="step_inner">
						...
						<div>合計<span id="tot_amount">0</span>枚</div>
...
<!--<tr>
	<td colspan="5">コンビニ手数料</td>
	<td class="conbifee">0</td>
	<td></td>
</tr>-->									<tr><td colspan="5">袋詰代</td><td class="package">0</td><td></td></tr>
						...
						?>
							...
							<div class="inner1">
								<table id="conf_item">
									...
									<thead>
										<tr>
											<th style="min-width:80px;">商品名 / カラー</th><th>サイズ</th><th>単価</th><th>枚数</th><th>金額</th>
										</tr>
									</thead>
									<tfoot>
