<?php
	//require_once dirname(__FILE__).'/../home/php_libs/conndb_getHolidayinfo.php';
	require_once dirname(__FILE__).'/../home/php_libs/conndb_holiday.php';
	require_once $_SERVER['DOCUMENT_ROOT'].'/../cgi-bin/JSON.php';



	define('_DOMAIN', 'http://sweatjack.jp');
